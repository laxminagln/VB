...
from pkg_ros_iot_bridge.msg import myActionMsgAction       # Message Class that is used by ROS Actions internally
from pkg_ros_iot_bridge.msg import myActionMsgGoal         # Message Class that is used for Goal messages
from pkg_ros_iot_bridge.msg import myActionMsgResult       # Message Class that is used for Result messages
from pkg_ros_iot_bridge.msg import myActionMsgFeedback     # Message Class that is used for Feedback messages
